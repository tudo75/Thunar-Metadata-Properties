...
namespace TMP {
    ...
    /**
    * PDF File Handler implementing FileHandler interface.
    */
    public class PdfHandler : GLib.Object, FileHandler {
        private const int MAX_FONTS = 20;
        private File file;
        ...
        /**
        * Constructor: Load the PDF document and scan for embedded fonts.
        * @param f The GLib.File representing the PDF file.
        */
        public PdfHandler(File f) {
            this.file = f;
            
            // DEBUG: Force print to verify constructor started
            debug_print(_("PdfHandler: Init started for %s\n"), f.get_uri());
            stdout.flush();
        ...
        */
        ...
        /**
        * Get the properties panel widget for the PDF file.
        ...
        */
        ...
        /**
        * Scan the PDF document for embedded fonts.
        */
        private void scan_fonts() {
            ...
            do {
                ...
                // Example: • Arial
                //            TrueType
                string display = "• <b>%s</b>\n  <span size='small'>%s</span>".printf(safe_name, type);
        ...
        /**
        * Get a human-readable name for the Poppler.FontType.
        * @param type The Poppler.FontType enum value.
        * @return A string representing the font type.
        */
